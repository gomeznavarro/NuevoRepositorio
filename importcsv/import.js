// JavaScript Document
    $(document).ready(function(){
		...
		$('#f').change(function(){
			...
			$('#hola').append("<p>Demasiado grande</p>");
			$('#registro').click(function(){
				return;
			});
			}
			else{
			$('#hola').append("<p>Este está bien</p>");
			$('#registro').submit();
			}
		})
	...
	*/
    ...
    function subirCv() {
        ...
        document.getElementById('registro').method="post";
        document.getElementById('registro').action="upload_files.php?action=save_file";
        document.getElementById('registro').submit();

    }
    
    //Importante para que al subir el cv si ha habido error, conserve el id_candidato y el id_publicacion
    function subirCv2() {		
